...
export default function Collections() {
  ...
  return (
    <div className="font-sans" style={{ backgroundColor: "#F8F8F8", color: "#2D2D2D", scrollBehavior: "smooth" }}>
      ...
      >
        <h2 className="text-4xl font-normal mb-12 tracking-widest uppercase" style={{ color: "#2D2D2D" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl w-full mt-10">
            {categories.map((category) => (
              ...
              >
                ...
                <div className="w-full h-64 overflow-hidden bg-gray-100">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = `https://placehold.co/600x600/2d2d2d/b89c60?text=${encodeURIComponent(category.name)}`;
                    }}
                  />
                </div>
                ...
                {/* Category Info */}
                <div className="p-6">
                  <h3 className="text-2xl font-semibold mb-2 group-hover:text-[#B89C60] transition-colors" style={{ color: "#2E4A3B" }}>
                    {category.name}
                  </h3>
                  <div className="w-20 h-1 mx-auto bg-[#B89C60] group-hover:w-32 transition-all duration-300 mb-4"></div>
                  <p className="text-sm text-gray-600 mb-4">Explore our curated collection</p>
