export default function Footer() {
  return (
    <footer id="contact" className="bg-gray-900 text-white py-12 px-6 lg:px-20 text-center">
      <h3 className="text-3xl mb-4 tracking-widest" style={{ color: "#B89C60" }}>Connect with ZYRAH</h3>
      ...
      <div className="text-sm mb-6 space-y-2">
        ...
        <p className="flex items-center justify-center">
          ...
          Email: <a href="mailto:Zyrahdesigns@gmail.com" className="ml-1 hover:underline transition duration-300" style={{ color: "#F8F8F8" }}>Zyrahdesigns@gmail.com</a>
        </p>
        ...
        <p className="flex items-center justify-center">
          ...
          Phone: <a href="tel:+971547081910" className="ml-1 hover:underline transition duration-300" style={{ color: "#F8F8F8" }}>+971547081910</a>
        </p>
      ...
      <div className="flex items-center justify-center text-sm uppercase font-medium mb-8 space-x-6">
        <a
          ...
          rel="noreferrer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="#B89C60">
      ...
      <p className="text-xs text-gray-500 mt-6">&copy; {new Date().getFullYear()} ZYRAH. All Rights Reserved. Crafted with attention to detail.</p>
    </footer>
  );
}
